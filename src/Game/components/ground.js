function createGround(size, position) {
    // ground
    var groundGeometry = new THREE.BoxGeometry(size.x,size.y,size.z);
    var groundMaterial = new THREE.MeshBasicMaterial( { color: 0xcccccc, side: THREE.DoubleSide, opacity: 0.0, transparent: true, depthWrite: false } );
